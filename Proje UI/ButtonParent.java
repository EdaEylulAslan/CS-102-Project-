...
public class ButtonParent{
    ...
    public ButtonParent(int x, int y, int h, int w, String image, String imageOver, String imagePressed){
        playImageLoad(image);
    ...
    public ButtonParent(int x, int y, int h, int w, BufferedImage image, BufferedImage imageOver, BufferedImage imagePressed){
        this.image = image;
